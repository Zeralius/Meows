...
Plugin id `meows.saucer`. Windows only: it talks to the Windows clipboard directly.
...
the only thing here that writes anything, and closing Meows forgets the lot.
