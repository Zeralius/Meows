...
Plugin id `meows.molt`. Windows only, because deletion goes through the shell's Recycle Bin.
...
This is the one place in Meows where the Recycle Bin is not automatically the right answer.
