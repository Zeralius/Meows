...
Plugin id `meows.litter`. Windows only, because deletion goes through the shell's Recycle Bin.
...
Everything goes to the Recycle Bin through the same `Meows.Disk` code Purrge and Chonk delete
