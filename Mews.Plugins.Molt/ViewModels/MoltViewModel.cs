...
namespace Mews.Plugins.Molt.ViewModels;
...
public sealed class MoltViewModel : ObservableObject, IDisposable
{
    ...
    public MoltViewModel(IMewsHost host)
    {
        _host = host;
    ...
    /// <summary>
    /// Off by default. The bin is the house rule everywhere else in Mews, and someone who wants
